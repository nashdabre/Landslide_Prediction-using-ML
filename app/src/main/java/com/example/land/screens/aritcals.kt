...
@Composable
fun articel(navController: NavHostController) {
    Column(
        Modifier
            .fillMaxSize()
            .fillMaxHeight()
        ...
        Column(
            ...
            Box(
                ...
                Image(
                    ...
                    modifier = Modifier
                        ...
                        .padding(7.dp)
                        .clickable {
                            navController.navigate(Routes.Youtube.routes) {
                                popUpTo(navController.graph.startDestinationId)
                                launchSingleTop = true
                            }
...

            {
                androidx.compose.material.Text(
                    text = "Landslide Mock drill", style = TextStyle(
...
//---------------------------------------------------------------------------------------------------
        Column(
            ...
            {
                androidx.compose.material.Text(
                    text = "What is landslide", style = TextStyle(
                        fontWeight = FontWeight.Bold,
                        fontSize = 14.sp,
    ...
    Row(
        ...
        Column(
            ...
            {
                androidx.compose.material.Text(
                    text = "Warnign Signs of Landslide", style = TextStyle(
                        fontWeight = FontWeight.Bold,
                        fontSize = 14.sp,
...
//-----------------------------------------------------------------------------------------
        Column(
            ...
            {
                androidx.compose.material.Text(
                    text = "Landslide Prevention", style = TextStyle(
                        fontWeight = FontWeight.Bold,
                        fontSize = 14.sp,
